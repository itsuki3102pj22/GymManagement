                ...
                datasets: [
                    {
                        ...
                        pointRadius: 4, pointBackgroundColor: '#1a56a0', borderWidth: 2.5,
                    },
                    {
                        label: '予測体重',
                        data: forecast,
                        ...
                        pointRadius: 2, pointBackgroundColor: '#b8952a', borderWidth: 2, fill: false,
                    },
                ],
            },
            options: {
                ...
                scales: {
                    x: {
                        type: 'time',
                        time: { unit: 'week', displayFormats: { week: 'M/d' } },
                    ...
                    y: {
                        min: yMin, max: yMax,
                        grid: { color: 'rgba(0,0,0,0.04)' },
                        ticks: { color: '#8fa3b8', font: { size: 11 }, callback: v => v + ' kg' },
                    },
                },
            },
            plugins: [{
